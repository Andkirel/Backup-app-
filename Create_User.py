...
class Create_User(customtkinter.CTk):
    ...
    def UserB(self):
        ...
        self.Pin_entry = customtkinter.CTkEntry(self.Middle_frame, width=250, height=25, corner_radius=10,placeholder_text="4 digit Pin")
        self.Pin_entry.place(relx=0.5, rely=0.4, anchor=tkinter.CENTER)
        self.CPin_entry = customtkinter.CTkEntry(self.Middle_frame, width=250, height=25, corner_radius=10,placeholder_text="Confirm Pin")
